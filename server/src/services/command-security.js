...
export class SecurityConfig {
  constructor(options = {}) {
    ...
    this.destructiveCommands = this.parsePatterns(
      process.env.AICLI_DESTRUCTIVE_COMMANDS || options.destructiveCommands || 
    ...
    this.enableAudit = 
      ...
      options.enableAudit !== false; // Default true
...
export class CommandSecurityService extends EventEmitter {
  ...
  isDestructiveCommand(command) {
    ...
    const isBuiltinDestructive = destructivePatterns.some(pattern => 
