...
struct ChatView: View {
                ...
                HStack {
                    Button(action: {
                        ...
                        ZStack {
                            ...
                            if toolActivityManager.activeTools.count > 0 {
                                Circle()
                                    .fill(Color.blue)
            ...
            DispatchQueue.main.async {
                ...
                case .success(let success):
                    if success {
                        ...
                        let _ = self.projectAwarenessService.analyzeProject(at: directory)
    ...
    private func loadConversation(_ conversation: Conversation) {
        ...
        if let workingDir = conversation.workingDirectory {
            ...
            let _ = projectAwarenessService.analyzeProject(at: workingDir)
        }
    }
