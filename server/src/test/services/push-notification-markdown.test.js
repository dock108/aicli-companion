...
import { MessageFormatter } from '../../services/push-notification/message-formatter.js';
...
describe('PushNotificationService - Markdown Stripping', () => {
  ...
  describe('stripMarkdown', () => {
    it('should remove code blocks', () => {
      ...
      assert.strictEqual(formatter.stripMarkdown(input), expected);
    });
...
Remember: Always test your code!`;
    ...
    it('should handle empty or null input', () => {
      assert.strictEqual(formatter.stripMarkdown(''), '');
      assert.strictEqual(formatter.stripMarkdown(null), '');
      assert.strictEqual(formatter.stripMarkdown(undefined), '');
    });
  });
  ...
  describe('truncateMessage', () => {
    it('should strip markdown before truncating', () => {
      ...
      const result = formatter.truncateMessage(input, 50);
    ...
    it('should truncate at word boundary when possible', () => {
      ...
      const result = formatter.truncateMessage(input, 40);
    ...
    it('should handle empty input', () => {
      assert.strictEqual(formatter.truncateMessage('', 50), '');
      assert.strictEqual(formatter.truncateMessage(null, 50), '');
      assert.strictEqual(formatter.truncateMessage(undefined, 50), '');
    });
...
And more text after the code block that continues for quite a while`;
      ...
      const result = formatter.truncateMessage(input, 100);
